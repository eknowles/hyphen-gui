...
Scheme
{
	...
	BaseSettings
	{
		...
		CheckButton.SelectedTextColor	"HyphenBlue"
		CheckButton.BgColor				"TransparentBlack"
		CheckButton.Border1  			"Border.Dark" 		// the left checkbutton border
		CheckButton.Border2  			"Border.Bright"		// the right checkbutton border
		CheckButton.Check				"HyphenBlue"				// color of the check itself
		...
		Frame.BgColor					"10 10 10 128"
		Frame.OutOfFocusBgColor			"10 10 10 32"
		...
		ListPanel.SelectedTextColor			"HyphenBlue"
		ListPanel.SelectedBgColor			"Black"
		ListPanel.SelectedOutOfFocusBgColor	"255 155 0 128"
		ListPanel.EmptyListInfoTextColor	"OffWhite"

		Menu.TextColor					"White"
		Menu.BgColor					"160 160 160 32"
		Menu.ArmedTextColor				"HyphenBlue"
		...
		ProgressBar.FgColor				"HyphenBlue"
		...
		RichText.SelectedTextColor		"HyphenBlue"
		...
		ScrollBarSlider.FgColor				"HyphenBlue"			// nob color
		...
		SectionedListPanel.SelectedTextColor			"HyphenBlue"
		...
		TextEntry.SelectedTextColor	"HyphenBlue"
